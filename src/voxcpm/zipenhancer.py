...
class ZipEnhancer:
    ...
    def _normalize_loudness(self, wav_path: str):
        ...
        try:
            ...
            # TorchCodec/FFmpeg issues can prevent torchaudio.load() on some setups;
            # skip normalization instead of failing the whole pipeline.
            print(f"[ZipEnhancer] Skip loudness normalization due to error: {e}")
